...
export default function HostNavbar() {
  ...
  return (
    <>
      <nav
        className={`relative sticky top-0 z-[200] w-full border-b border-gray-200/80 bg-white/95 shadow-[0_10px_30px_rgba(15,23,42,0.06)] backdrop-blur-xl transition-transform duration-300 ${
          isScrolledDown
