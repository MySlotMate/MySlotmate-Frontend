const Idea=()=>{
    return(
        <div className="mx-auto my-10 w-full max-w-7xl site-x">
            <div className="flex w-full flex-col items-center justify-center rounded-2xl p-8" style={{background: "linear-gradient(180deg, rgba(0, 148, 202, 0.1) 0%, rgba(255, 255, 255, 0.1) 100.13%)",border: "1.63px solid #0094CA33"}}>
