  ...
  return (
    <footer className="mt-4 w-full border-t border-[#aeddf873] bg-[linear-gradient(180deg,#dff2ff,#f4fbff)]">
      <div className="site-x">
        <div className="mx-auto w-full max-w-[1120px] pb-0 pt-8 md:pb-0 md:pt-10">
          <div className="grid grid-cols-2 justify-items-center gap-8 text-center md:grid-cols-4 md:text-left"> {/* Mobile: 2 cols so Quick Links + For Hosts share a row */}
            <div className="col-span-2 md:col-span-1">
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src="/assets/home/logo.png" alt="Myslotmate" loading="lazy" className="mx-auto mb-3 h-10 w-auto md:mx-0" />
            ...
            <div className="col-span-2 flex w-full flex-col items-center justify-start md:col-span-1 md:items-start">
              <h4 className="text-sm font-bold text-[#16304c]">Subscribe</h4>
              <div className="mt-3 flex w-full max-w-sm flex-row items-center md:max-w-none">
                <input
                  type="text"
          ...
          <div className="flex flex-col items-center justify-center gap-4 border-t border-[#aeddf873] pt-3 text-sm text-[#000000] md:flex-row">
