        ...
        <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link
              ...
              className="flex items-center gap-2 rounded-lg bg-[#0094CA] px-4 py-2.5 text-sm font-semibold text-white transition hover:bg-[#007dab]"
            >
            ...
            <div className="rounded-xl border border-gray-200 bg-white lg:col-span-3">
              ...
              <div className="flex items-center justify-between border-b border-gray-100 px-5 py-4">
                <div className="flex items-center gap-3">
                  ...
                  <span className="min-w-35 text-center text-base font-semibold text-gray-900">
                  ...
                  <div className="grid grid-cols-7 border-b border-gray-100">
                    {["SUN", "MON", "TUE", "WED", "THU", "FRI", "SAT"].map(
                      (d) => (
                        <div
                          key={d}
                          className="px-2 py-3 text-center text-[11px] font-semibold tracking-wide text-gray-400 uppercase"
                        >
                          {d}
                        </div>
                      ),
                    ...
                    {gridDays.map((day, idx) => {
                      ...
                      return (
                        <button
                          ...
                          className={`relative min-h-25 border-r border-b border-gray-100 p-2 text-left transition hover:bg-gray-50 ${
                            isSelected ? "bg-[#e6f8ff]" : ""
                          } ${inMonth ? "" : "bg-gray-50/50"} ${isLastRow ? "border-b-0" : ""}`}
                        >
                          <span
                            className={`text-sm font-medium ${inMonth ? "text-gray-900" : "text-gray-400"}`}
                          >
                            {format(day, "d")}
                          </span>
                            ...
                            {dayEvents.slice(0, 2).map((ev) => {
                              ...
                              return (
                                <div
                                  ...
                                  className={`cursor-pointer truncate rounded px-1.5 py-0.5 text-[10px] font-medium ${bgColor}`}
                                >
                                  {time} {ev.title}
                                </div>
                              );
                ...
                <>
                  ...
                  <div className="mt-5 border-t border-gray-100 pt-4">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-xs text-gray-500">
                        {selectedEvent.total_bookings}/{selectedEvent.capacity}{" "}
                        filled
                      </span>
                    </div>
                    ...
                    {attendees && attendees.length > 0 && (
                      <p className="mt-3 text-xs text-[#0094CA]">
                        +{selectedEvent.total_bookings} guests requesting
                        details
                      </p>
                    )}
                  </div>
                  ...
                  <div className="mt-5 space-y-2">
                    <Link
                      ...
                      className="flex w-full items-center justify-center gap-2 rounded-lg bg-[#0094CA] px-4 py-2.5 text-sm font-semibold text-white transition hover:bg-[#007dab]"
                    >
                      <FiMessageCircle className="h-4 w-4" />
                      Message All
                    </Link>
                    <button className="w-full py-2 text-center text-sm font-medium text-red-600 hover:text-red-700">
                      Cancel Session
                    </button>
                  </div>
                </>
