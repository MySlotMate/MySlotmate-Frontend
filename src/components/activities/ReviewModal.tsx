  ...
  return (
    <div className="fixed inset-0 z-[320]">
      ...
      <div className="relative z-[330] flex min-h-full items-center justify-center p-4">
        ...
        {/* Header */}
          <div className="relative overflow-hidden border-b border-[#d7e8f2] bg-gradient-to-br from-[#f7fbff] via-white to-[#e8f7ff] px-6 pb-6 pt-6 sm:px-8">
            <div className="pointer-events-none absolute -right-10 -top-10 h-28 w-28 rounded-full bg-[#0094CA]/12 blur-2xl" />
            ...
            <div className="relative pr-14">
              ...
              <p className="mt-4 max-w-lg text-sm leading-6 text-slate-500">
                Share what stood out, what the experience felt like, and what future guests should know.
              </p>
            </div>
          </div>
          ...
          {/* Description */}
            <div className="rounded-2xl border border-slate-200 bg-white p-5">
              ...
              <textarea
                ...
                rows={6}
                className="min-h-40 w-full resize-none rounded-2xl border border-slate-200 px-4 py-3 text-sm text-slate-700 outline-none transition placeholder:text-slate-400 focus:border-[#0094CA] focus:ring-4 focus:ring-[#0094CA]/10"
                disabled={loading}
              />
